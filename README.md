...
"HPC:*" labelled codes contain my assigment solutions for my final year high performance and parallel computing modules, which covered a range of methods including OpenMP, OpenMPI and CUDA. Codes labelled "HPC utils" contain some of the neccesary utilities to generate random numbers and constructs pngs of solutions.
